    ...
    <div class="management">
        <div class="change_access">
                ...
                while ($row_change = $result_change->fetch_assoc()){
                    ...
                    //to all accounts information for the manager
                    ...
                    ?>
                        <tr >
                            ...
                            <td>
                            <select name='change'  id=<?php $account_change;?>>
                             <option value="" selected="selected">Please the access</option>
                             <option value=<?php $account_change;?>>1</option>
                             <option value=<?php $account_change;?>>2</option>
                            </select>
                            </td>
                            <td>
                            <form action="./manage_engine.php" method="POST">
                            <input type="hidden" name="id" value="<?php echo $account_change;?>">
